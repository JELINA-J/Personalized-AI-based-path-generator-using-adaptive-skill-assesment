      ...
      >
        ...
        <div className="grid gap-1.5">
          {payload.map((item, index) => {
            ...
            // Fix: Use conditional logic instead of object syntax with cn()
            let indicatorClass = "";
            if (indicator === "dot") {
              ...
              indicatorClass = "w-0 border-[1.5px] border-dashed bg-transparent";
            }

            const shouldAddMyClass = nestLabel && indicator === "dashed";
